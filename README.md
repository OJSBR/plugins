...
| orcidManualEntry | OJS · OMP | [⬇ 1.1.4.0](https://github.com/OJSBR/orcidManualEntry/releases/download/1.1.4.0/orcidManualEntry-1.1.4.0.tar.gz) | — | — |
| requiredAuthorMetadata | OJS · OMP | [⬇ 1.0.0.0](https://github.com/OJSBR/requiredAuthorMetadata/releases/download/1.0.0.0/requiredAuthorMetadata-1.0.0.0.tar.gz) | — | — |
