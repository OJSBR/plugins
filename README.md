...
| [requiredAuthorMetadata](https://github.com/OJSBR/requiredAuthorMetadata) | OJS · OMP | generic | Lets the journal require the affiliation and the biography of every contributor of a submission, each one on its own, and refuse to complete the submission while either is missing; journal managers and section editors can be exempt | 3.5 |
...
| orcidManualEntry | OJS · OMP | [⬇ 1.1.5.0](https://github.com/OJSBR/orcidManualEntry/releases/download/1.1.5.0/orcidManualEntry-1.1.5.0.tar.gz) | — | — |
| requiredAuthorMetadata | OJS · OMP | [⬇ 1.0.1.0](https://github.com/OJSBR/requiredAuthorMetadata/releases/download/1.0.1.0/requiredAuthorMetadata-1.0.1.0.tar.gz) | — | — |
